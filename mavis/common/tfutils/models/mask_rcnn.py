...
from mavis.cvutils import LabelMeJsonWrapper
from mavis.tfutils.dataset import PixelLibDataset
...
class PixelLibWrapper:
    ...
    def compile(self, **kwargs):
        ...
        self.train_instance.RPN_ANCHOR_SCALES = (1, 4, 8, 16, 32, 64, 128, 256)
